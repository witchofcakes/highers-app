...
class Footer_Vac extends React.Component {
    render() {
        return (
            <div className="footer-vacancy">
                <div className="row">
                    <div className="col-12 footer-container-2">
                        <div className="col-4 footer-logo">
                            <img src={logo} className="logo-mount-vacancy" />
                            <p className="copyright">© 2020 Copyright HIGHERS</p>
                        </div>
                        <div className="col-4 no-gutters links-footer">
                            <a target="_blank" className="footer-a" href="/all-vacancies">
                                Контакти
                            </a>
                            <a target="_blank" className="footer-a" href="https://t.me/highersdigest">
                                Блог
                            </a>
                        ...
                        <div className="col-4 footer-icons">
                            <div className="footer-icons-div">
                                ...
                                <a target="_blank" href="https://instagram.com/highers.official?igshid=l77dct5ul99v">
                                    <svg id="insta" height="38px" width="38px" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path d="m305 256c0 27.0625-21.9375 49-49 49s-49-21.9375-49-49 21.9375-49 49-49 49 21.9375 49 49zm0 0"/>
