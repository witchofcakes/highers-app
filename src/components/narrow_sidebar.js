...
export default class Narrow_SideBar extends React.Component {
    ...
    render() {
        ...
        return (
                    ...
                    <div className="col-3 narrow-sidebar no-gutters" id="leftCol-employer-narrow">
                        <div className="row">
                            <div className="col logo-employer">
                                <a className="navbar-brand" href="/"><img src={logo_mount} className="logo-mount-employer" /></a>
